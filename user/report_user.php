  ...
  <div class="content">
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="pilihan" onselect="lap_pilihan()">
                                    <option value="tb_data">OTS 1</option>
                                    <option value="tb_fpm">OTS 2</option>
                                </select>
                            </td>
                            <td></td>
                            <!-- <td>Cari Kode</td>
                ...
                <table border="1">
                    ...
                    <?php
                        ...
                        if(isset($_POST['cari'])){
                            ...
                            if($pilihan == 'tb_data') {
                                echo "<a class='tombol_export' href='../admin/export_act_ots1.php' target='_blank'>Export to Excel</a>";
                                echo "
      ...
      WHERE     (Jumlah_Order - ISNULL
                                ((SELECT     SUM(isnull(Qtykirim, 0)) AS Expr1
                                    FROM         SuratJalan_Dtl
                                    GROUP BY No_SPK
                                    HAVING      (No_SPK = SPK.NO_SPK)), 0)) > 10 AND STATUS >= 0 AND STATUS < 10 AND LEFT(no_SPK, 1) <> 'R' AND RIGHT(no_SPK, 1) <> 'B' AND RIGHT(no_SPK, 
                            1) <> 'C' AND RIGHT(no_SPK, 1) <> 'D'
      ORDER BY No_SPK");
                            // END QUERY SQL =======
                    ...
                    <?php
                        ...
                        }else if($pilihan == 'tb_fpm') {
                            echo "<a class='tombol_export' href='../admin/export_act_fpm.php' target='_blank'>Export to Excel</a>";
                            echo "
                                <tr style='background-color: #91aff4; font-size: 10px;'>
                                    <th>No</th>
                                    <th>No. Order</th>
